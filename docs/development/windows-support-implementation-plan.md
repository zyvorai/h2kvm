...
Transform h2kvm into the premier Windows VM migration tool by adding enterprise-grade Windows-specific features:
...
```python
# h2kvm/fixers/windows/license_mgr.py
...
```python
# h2kvm/fixers/windows/ad_mgr.py
...
```python
# h2kvm/fixers/windows/sql_server_mgr.py
...
```python
# h2kvm/fixers/windows/driver_update_mgr.py
