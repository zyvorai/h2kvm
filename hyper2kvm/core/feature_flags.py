...
def is_enabled(flag: str) -> bool:
    ...
    # Environment variable: HYPER2KVM_FF_<FLAG>=1
    env_key = f"HYPER2KVM_FF_{flag.upper()}"
...
def list_flags() -> dict[str, dict[str, Any]]:
    ...
    for flag, default in _DEFAULTS.items():
        result[flag] = {
            ...
            "env_var": f"HYPER2KVM_FF_{flag.upper()}",
        }
    return result
