...
def create_guestfs(
    *,
    ...
    Environment Variables:
        HYPER2KVM_GUESTFS_BACKEND: Override backend selection (auto, guestfs, vmcraft)
    ...
    if backend not in ("auto", "guestfs", "vmcraft"):
        raise ValueError(
            ...
            f"    Or set environment variable: HYPER2KVM_GUESTFS_BACKEND=vmcraft"
        )
    ...
    if backend == "auto":
        ...
        from hyper2kvm.vmcraft import VMCraft  # pylint: disable=import-outside-toplevel
