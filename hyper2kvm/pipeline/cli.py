...
"""
Hyper2KVM Encryption Pipeline - CLI Interface

Automated VMware VMDK → LUKS2 + TPM conversion pipeline.

Usage:
    hyper2kvm-encrypt convert <vmdk> [options]
    hyper2kvm-encrypt --help

Examples:
    # Basic conversion with default output
    hyper2kvm-encrypt convert /vms/centos8.vmdk

    # Custom output path
    hyper2kvm-encrypt convert /vms/centos8.vmdk -o /encrypted/centos8.raw

    # Custom PCRs
    hyper2kvm-encrypt convert /vms/ubuntu.vmdk --pcrs 0,1,7

    # Skip TPM enrollment (LUKS only)
    hyper2kvm-encrypt convert /vms/vm.vmdk --no-tpm
"""
...
from .vmware_to_luks_tpm import Hyper2KVMVMwareToLUKSPipeline
...
def setup_logging(verbose: bool = False):
    ...
    return logging.getLogger("hyper2kvm.encrypt")
...
For more information:
  https://github.com/anthropics/hyper2kvm
    """)
    return 0
...
Examples:
  ...
  # Custom output path
  hyper2kvm-encrypt convert /vms/ubuntu.vmdk -o /encrypted/ubuntu.raw

  # Custom PCR banks
  hyper2kvm-encrypt convert /vms/vm.vmdk --pcrs 0,1,7

  # Verbose output
  hyper2kvm-encrypt convert /vms/vm.vmdk -v
