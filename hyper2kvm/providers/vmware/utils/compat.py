...
# hyper2kvm/vmware/utils/compat.py

"""
Shared optional-dependency compatibility shims for the VMware provider package.

Several modules under hyper2kvm/providers/vmware/ independently probed the
...
try:
    from hyper2kvm.providers.vmware.transports.http_client import VMwareError
except ImportError:  # pragma: no cover
    try:
        from hyper2kvm.core.exceptions import VMwareError  # type: ignore
    except ImportError:  # pragma: no cover
