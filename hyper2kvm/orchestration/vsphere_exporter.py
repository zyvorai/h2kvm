...
from hyper2kvm.core.cred import resolve_vsphere_creds
from hyper2kvm.core.error_helpers import vm_not_found_error
from hyper2kvm.core.exceptions import Fatal, VMwareError
                ...
                try:
                    ...
                    if create_snapshot:
                        ...
                        snap_obj = vc.create_snapshot(  # pylint: disable=no-member
                            vm_obj, name=f"hyper2kvm-{vm_name}", quiesce=True, memory=False
                        )
