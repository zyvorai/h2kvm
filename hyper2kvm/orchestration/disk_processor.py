...
from hyper2kvm.config.pipeline_config import DiskProcessingConfig, resolve_enable_rdp
...
from hyper2kvm.core.utils import U, effective_cpu_count
...
from hyper2kvm.quality.validation.vmdk_inspector import RiskLevel, VMDKInspector
...
class DiskProcessor:  # pylint: disable=too-many-instance-attributes
    ...
    def _auto_detect_uefi_from_partitions(self, disk: Path) -> None:
        ...
        # hyper2kvm/fixers/offline_fixer.py (lvs LVM scan) -- structurally
