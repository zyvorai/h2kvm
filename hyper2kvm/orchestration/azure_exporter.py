...
# Conditional imports
try:
    from hyper2kvm.providers.azure import AzureConfig, AzureSourceProvider
    from hyper2kvm.providers.azure.models import (
        AzureDownloadConfig,
        AzureExportConfig,
        AzureSelectConfig,
        AzureShutdownConfig,
    ...
    def export_vms(self, out_root: Path) -> list[Path]:
        ...
        if not AZURE_AVAILABLE:
            raise Fatal(
                ...
                "Or install with Azure support: pip install hyper2kvm[azure]",
            )
