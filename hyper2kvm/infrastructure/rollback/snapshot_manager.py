...
# hyper2kvm/rollback/snapshot_manager.py
"""
...
class SnapshotManager:
    ...
    def __init__(self, logger: logging.Logger, snapshot_dir: Path | None = None):
        ...
        Args:
            ...
            snapshot_dir: Directory for storing snapshots (default: /var/lib/hyper2kvm/snapshots)
        """
        self.logger = logger
        self.snapshot_dir = snapshot_dir or Path("/var/lib/hyper2kvm/snapshots")
