...
try:
    ...
    # package directory (hyper2kvm/infrastructure/systemd/) happens to share
...
class JournalMonitor:
    ...
    def __init__(self):
        ...
        self.reader.add_match(_SYSTEMD_UNIT__startswith="hyper2kvm")
...
def setup_journal_handler(logger: logging.Logger):
    ...
    journal_handler = systemd.journal.JournalHandler(SYSLOG_IDENTIFIER="hyper2kvm")
