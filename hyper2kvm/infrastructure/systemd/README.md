# Systemd Integration for Hyper2KVM
...
```python
from hyper2kvm.systemd import SystemdFirstBootManager
...
```python
from hyper2kvm.systemd import SystemdResourceControl
...
```python
from hyper2kvm.systemd import RepairSocketServer
...
```python
from hyper2kvm.systemd import check_systemd_available

if not check_systemd_available():
    print("Systemd integration not available")
    print("Install: pip install 'hyper2kvm[systemd]'")
```
