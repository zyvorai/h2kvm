# hyper2kvm zkvm - Backend Components

This package contains the Python backend components for the hyper2kvm TUI.
...
- Root: `/run/hyper2kvm/zkvm.sock`
- User: `$XDG_RUNTIME_DIR/hyper2kvm/zkvm.sock`
