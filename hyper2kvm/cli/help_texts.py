...
#
# Windows extras:
# virtio_drivers_dir: /path/to/virtio-win.iso  # override; auto-discovered at /var/lib/hyper2kvm/virtio-win.iso
...
# # Note: virtio_drivers_dir is optional if virtio-win.iso is at /var/lib/hyper2kvm/virtio-win.iso
# command: local
