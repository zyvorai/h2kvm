...
from hyper2kvm.runtime.daemon.control import DEFAULT_CONTROL_SOCKET, DaemonControlClient
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        help="Daemon output directory (legacy; control socket is always under /run/hyper2kvm)",
    )
