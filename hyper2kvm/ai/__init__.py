...
# hyper2kvm/ai/__init__.py
"""
AI-powered migration intelligence for hyper2kvm.
...
All heavy imports are lazy so ``import hyper2kvm.ai`` is cheap.
"""
...
def __getattr__(name: str) -> Any:
    # pylint: disable=import-outside-toplevel  # deliberate PEP 562 lazy exports: keeps `import hyper2kvm.ai` cheap
    ...
    raise AttributeError(f"module 'hyper2kvm.ai' has no attribute {name!r}")
