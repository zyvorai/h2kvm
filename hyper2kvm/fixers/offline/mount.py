...
from hyper2kvm.core.utils import U, guest_has_cmd
from hyper2kvm.fixers.filesystem import fixer as filesystem_fixer  # type: ignore
from hyper2kvm.fixers.filesystem.fstab import parse_btrfsvol_spec

# This TYPE_CHECKING guestfs/GuestFS typing shim is intentionally duplicated
# verbatim in hyper2kvm/fixers/offline/config_rewriter.py (and other offline
