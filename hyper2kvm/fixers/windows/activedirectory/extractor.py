...
# hyper2kvm/fixers/windows/license/extractor.py -- both are small hivex
...
def _read_registry_sz_value(h, key_path: str, value_name: str):
    ...
    Mirrors the local helper in hyper2kvm.fixers.windows.license.extractor since
    ...
    from hyper2kvm.fixers.windows.registry.encoding import (  # pylint: disable=import-outside-toplevel
        _hivex_read_sz,
...
def extract_domain_info(guestfs, root: str) -> DomainInfo:
    ...
    from hyper2kvm.fixers.windows.registry.io import (  # pylint: disable=import-outside-toplevel
        detect_windows_hive,
