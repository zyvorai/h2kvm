...
def enable_trim_discard(
    ...
    # in hyper2kvm/fixers/windows/performance/msi.py's enable_msi_interrupts()
    ...
    try:
        from hyper2kvm.fixers.windows.registry.encoding import _close_best_effort
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            try:
                ...
                if not filesystem_node:
                    from hyper2kvm.fixers.windows.registry.encoding import _ensure_child
                ...
                if filesystem_node:
                    from hyper2kvm.fixers.windows.registry.encoding import _set_dword
                ...
                # Commit changes
                from hyper2kvm.fixers.windows.registry.encoding import _commit_best_effort
