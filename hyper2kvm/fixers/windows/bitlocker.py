...
from hyper2kvm.core.exceptions import BitLockerDetectionError, WindowsFixerError, create_helpful_error
...
def _read_bitlocker_service_info(  # pylint: disable=too-many-locals,too-many-return-statements,too-many-branches
    ...
    # hyper2kvm/fixers/windows/firewall.py's _read_service_start_type() --
    ...
    # mirrors hyper2kvm/fixers/windows/firewall.py's
