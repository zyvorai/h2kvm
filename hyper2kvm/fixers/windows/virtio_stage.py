...
from hyper2kvm.fixers.windows.virtio_injector import (
...
from hyper2kvm.libvirt.domain_emitter import _default_graphics, auto_detect_ovmf
from hyper2kvm.libvirt.libvirt_utils import find_qemu_binary
...
class VirtioStagedDeployer:
    ...
    def _apply_offline_fixes(self) -> None:
        ...
        try:
            ...
            mount_point = Path(tempfile.mkdtemp(prefix="hyper2kvm-pre-"))
            subprocess.run(
...
"""
    ...
    def _verify_drivers_offline(self) -> tuple[list[str], list[str]]:
        ...
        try:
            ...
            mount_point = Path(tempfile.mkdtemp(prefix="hyper2kvm-verify-"))
            subprocess.run(
