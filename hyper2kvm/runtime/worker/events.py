...
class EventStore:
    ...
    def __init__(self, storage_dir: Path | None = None):
        ...
        Args:
            storage_dir: Directory for event storage (default: /tmp/hyper2kvm/events)
        """
        self.storage_dir = storage_dir or Path("/tmp/hyper2kvm/events")
