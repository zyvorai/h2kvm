...
from hyper2kvm.systemd._common import check_systemd_binary_available, parse_binary_size
...
class SystemdCgtop:
    ...
    def snapshot(
        ...
        *,
        ...
        # hyper2kvm/systemd/delta.py's find_overrides() and
        # hyper2kvm/systemd/escape.py's systemd_escape() -- coincidental,
    ...
    def monitor_service(
        ...
        *,
        ...
        ----------
        service_name : str
            Systemd service name (e.g., "hyper2kvm-migration.service")
        ...
        --------
        >>> cgtop = SystemdCgtop()
        >>> stats = cgtop.monitor_service("hyper2kvm-migration.service", duration=30)
