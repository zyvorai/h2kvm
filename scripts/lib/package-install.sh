...
pkg_install_welcome "Hyper2KVM"
pkg_banner "Hyper2KVM" "vSphere / libvirt conversion · Python venv bundle"
pkg_step_init 4
...
[[ -x ./bin/hyper2kvm ]] && [[ -x ./bin/h2kweb ]] && pkg_ok "venv wrappers: hyper2kvm + h2kweb" || { pkg_fail "bin/hyper2kvm or bin/h2kweb missing"; exit 1; }
...
pkg_install_finish "Hyper2KVM" http 5070 "" \
