...
def welcome_pdf(pdf_path: Path, logo_path: Path, product: str, version: str) -> None:
    ...
    pdf.cell(
        0,
        6,
        _safe(f"Version {version} · linux-amd64 · ready to install"),
        align="C",
        new_x=XPos.LMARGIN,
        new_y=YPos.NEXT,
    )
    ...
    pdf.cell(
        0,
        5,
        "Open docs/welcome.html in your browser  ·  or docs/pdf/WELCOME.pdf",
        align="C",
        new_x=XPos.LMARGIN,
        new_y=YPos.NEXT,
    )
...
"""
    ...
    content = (
        content.replace("motion-div", "motion-div")
