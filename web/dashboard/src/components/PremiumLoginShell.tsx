...
export function PremiumLoginShell({
  variant = 'default',
  accent = 'blue',
  pageThemeClass: pageThemeClassProp = '',
  heroWidth = '58',
  themeSwitcher,
  logo,
  productName,
  ...
  const pageThemeClass = variant === 'macos'
    ? `login-page-macos ${pageThemeClassProp}`.trim()
    : pageThemeClassProp;
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      >
        {!isMacos && <div className="login-aurora" aria-hidden />}
        {!isMacos && <div className="login-scanline" aria-hidden />}
