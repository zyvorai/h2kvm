...
-------------------------------------------
h2kvm configuration file format
-------------------------------------------
...
**h2kvm** uses YAML or JSON configuration files to define migration workflows.
...
h2kvm supports both YAML and JSON formats. YAML is recommended for its
...
**workdir** (*string*)
    Temporary working directory (default: ``/tmp/h2kvm-<random>``).
...
**virtio_drivers_dir** (*string*)
    ...
    If not specified, h2kvm auto-discovers the ISO at the standard location
    ``/var/lib/h2kvm/virtio-win.iso``. Install the standard ISO with::
...
::
    ...
    out_format: qcow2
    compress: true
    # virtio_drivers_dir auto-discovered at /var/lib/h2kvm/virtio-win.iso
