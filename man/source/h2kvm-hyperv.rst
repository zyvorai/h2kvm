...
**h2kvm hyperv** [*OPTIONS*]

**h2kvm** **--config** *FILE* **hyperv**
...
Convert locally available VHD/VHDx files::
    ...
    h2kvm local --vmdk /path/to/vm.vhdx --output-dir ./output
...
::
    ...
    h2kvm local --vmdk /vms/windows-server.vhdx --output-dir ./output
...
::
    ...
    h2kvm --config hyperv-migration.yaml hyperv
