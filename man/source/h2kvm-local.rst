...
**h2kvm** **--vmdk** *FILE* **--output-dir** *DIR* **local**
...
Convert a VMDK to compressed QCOW2::
    ...
    h2kvm local --vmdk /vms/ubuntu.vmdk --output-dir ./output --compress
...
Create config file::
    ...
    h2kvm --config local-migration.yaml local

FILES
=====

See **h2kvm**\(1) for configuration file locations.
