...
from h2kvm.providers.vmware.clients.client import PYVMOMI_AVAILABLE, REQUESTS_AVAILABLE
...
class InventoryMode:
    ...
    def run(self) -> None:
        ...
        if source in ("local", "dir"):
            ...
            artifacts["notes"].append("Use: h2kvm vsphere list_vm_names / get_vm_by_name / vm_disks")
