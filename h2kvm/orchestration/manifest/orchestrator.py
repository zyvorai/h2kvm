...
from h2kvm.infrastructure.hooks import HookRunner, create_hook_context
...
class ManifestOrchestrator:
    ...
    def _stage_libvirt_integration(self) -> dict[str, Any]:
        ...
        from h2kvm.libvirt import LIBVIRT_AVAILABLE, LibvirtManager, PoolManager
                ...
                with LibvirtManager(self.logger) as manager:
                    ...
                    if libvirt_config.get("create_snapshot", False):
                        ...
                        manager.create_snapshot(
                            domain,
                            snapshot_name,
                            description="Snapshot created by h2kvm before first boot",
                        )
