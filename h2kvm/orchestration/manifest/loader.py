...
from h2kvm.core.exceptions import ManifestError
from h2kvm.orchestration.profiles import ProfileLoader
    ...
    def _validate(self) -> None:
        ...
        if version not in self.SUPPORTED_VERSIONS:
            raise ManifestError(
                ...
                f"This h2kvm version supports: {self.SUPPORTED_VERSIONS}"
            )
