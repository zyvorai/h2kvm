...
This directory contains configuration file loaders and schemas for h2kvm.

## Configuration File Formats

H2kvm supports YAML and JSON configuration files for:
...
h2kvm --config common.yaml --verbose 2
```
...
h2kvm --config migration.yaml --dry-run

# Validate manifest
h2kvm --manifest batch-migration.yaml --validate-only
```
