...
This module provides high-level libvirt domain operations for h2kvm,
...
# exists-check pattern mirror h2kvm/libvirt/pool_manager.py, but connect()'s error
...
from h2kvm.core.constants import DELAY_LIBVIRT_OPERATION
