...
# h2kvm/libvirt/domain_emitter.py
...
from h2kvm.core.guest_identity import GuestDetector, GuestType, emit_guest_identity_log
    ...
    if guest_kind == "windows":
        if not _WIN_DOMAIN_OK or WinDomainSpec is None or render_windows_domain_xml is None:
            logger.warning(
                ...
                "    Install with: pip install h2kvm[libvirt]\n"
