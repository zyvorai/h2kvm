...
class LiveMigrationOrchestrator:
    ...
    async def _execute_offline_migration(
        ...
        # This would use existing h2kvm offline migration
        result = {
            "success": False,
            "mode": "offline",
        ...
        self.logger.warning("Offline migration selected - using traditional h2kvm workflow")
...
---
Generated by h2kvm Live Migration Orchestrator
"""
