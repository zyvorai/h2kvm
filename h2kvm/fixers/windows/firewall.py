...
# h2kvm/fixers/windows/firewall.py
...
def stage_firewall_export_script(  # pylint: disable=unused-argument
    ...
    try:
        ...
        script_path = f"{script_dir}/h2kvm-firewall-migrate.ps1"
...
def _generate_firewall_migration_script() -> str:
    ...
    """
    return r"""# h2kvm Firewall Migration Script
# Preserves Windows Firewall rules during VM migration

$ErrorActionPreference = "Stop"
$LogFile = "C:\Windows\Temp\h2kvm-firewall-migration.log"
...
try {
    # Export location
    $BackupPath = "C:\Windows\Temp\h2kvm-firewall-backup.wfw"
    $RulesPath = "C:\Windows\Temp\h2kvm-firewall-rules.xml"
...
<Task version="1.2" xmlns="http://schemas.microsoft.com/windows/2004/02/mit/task">
  <RegistrationInfo>
    <Description>h2kvm - Preserve Windows Firewall rules during migration</Description>
    <Author>h2kvm</Author>
  </RegistrationInfo>
  <Triggers>
    <BootTrigger>
  ...
  <Actions Context="Author">
    <Exec>
      ...
      <Arguments>-ExecutionPolicy Bypass -File "C:\Windows\Temp\h2kvm-firewall-migrate.ps1"</Arguments>
    </Exec>
  </Actions>
</Task>"""

        # Write task XML (absolute guest path)
        task_path = "/Windows/System32/Tasks/h2kvm-firewall-migration"
...
def _read_service_start_type(  # pylint: disable=too-many-locals,too-many-return-statements,too-many-branches,unused-argument
    ...
    # h2kvm/fixers/windows/bitlocker.py's _read_bitlocker_service_info()
    ...
    # mirrors h2kvm/fixers/windows/bitlocker.py's
