...
# h2kvm/fixers/windows/disk_online.py
"""
...
def _safe_logger(self) -> logging.Logger:
    return _safe_logger_base(self, "h2kvm.disk_online")
...
$LogPath = "C:\h2kvm\disk_online\disk-online.log"
...
Log "=== h2kvm disk online starting ==="
...
def stage_disk_online(self, g: guestfs.GuestFS) -> dict[str, Any]:
    ...
    try:
        ...
        result["notes"].append(r"Disk online script staged at C:\h2kvm\disk_online\online-disks.ps1")
