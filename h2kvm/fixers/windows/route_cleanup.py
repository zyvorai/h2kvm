...
# h2kvm/fixers/windows/route_cleanup.py
"""
...
def _safe_logger(self) -> logging.Logger:
    return _safe_logger_base(self, "h2kvm.route_cleanup")
...
$LogPath = "C:\h2kvm\route_cleanup\route-cleanup.log"
...
Log "=== h2kvm route cleanup starting ==="
...
def stage_route_cleanup(self, g: guestfs.GuestFS) -> dict[str, Any]:
    ...
    try:
        ...
        result["notes"].append(
            r"Route cleanup script staged at C:\h2kvm\route_cleanup\cleanup-routes.ps1"
        )
