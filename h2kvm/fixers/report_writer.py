...
# top-level h2kvm package is already fully initialized in sys.modules --
...
def _atomic_write_text(path: Path, content: str, suffix: str = ".tmp.h2kvm") -> None:
    """
