...
try:
    from h2kvm.providers.vmware.transports.http_client import HTTPDownloadClient, VMwareError
except ImportError:  # pragma: no cover
...
# NOTE: export functionality removed - h2kvm uses pure architecture now
