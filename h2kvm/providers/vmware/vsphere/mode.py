...
try:
    from h2kvm.providers.vmware.transports.http_client import (
        HTTPDownloadClient,
        HTTPDownloadOptions,
    )
...
try:
    from h2kvm.providers.vmware.clients.client import VMwareClient
    from h2kvm.providers.vmware.transports.govc_common import GovcRunner
    from h2kvm.providers.vmware.transports.ovftool_client import (
        OvfDeployOptions,
        OvfExportOptions,
        OvfToolAuthError,
        OvfToolError,
    ...
    if not vm:
        ...
        raise create_helpful_error(
            ...
            solutions=[
                ...
                "List all accessible VMs: h2kvm vsphere --vs-action list-vms",
