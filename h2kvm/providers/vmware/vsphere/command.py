...
# h2kvm/vmware/vsphere/command.py
"""
vSphere command orchestration for h2kvm.
"""
...
class VsphereCommands:
    ...
    def create_snapshot(self) -> Any:
        ...
        description = getattr(self.args, "description", "Created by h2kvm") or "Created by h2kvm"
    ...
    def cbt_sync(self) -> Any:
        ...
        snapshot_name = getattr(self.args, "snapshot_name", "h2kvm-cbt") or "h2kvm-cbt"
        change_id = str(getattr(self.args, "change_id", "*") or "*")
...
def run_vsphere_command(args: Any, conf: dict[str, Any] | None, logger: Any) -> int:
    """
    Entry point for: h2kvm.py vsphere <action> ...
