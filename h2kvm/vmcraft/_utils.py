...
from h2kvm.core.exceptions import MountError, VMCraftError  # noqa: F401  # pylint: disable=unused-import
...
def run_sudo(  # pylint: disable=too-many-arguments  # thin sudo/subprocess wrapper: each knob is a passthrough option
    ...
    *,
    ...
    vmcraft as root. Set `H2KVM_VMCRAFT_USE_SUDO=1` to force sudo prefixing
    ...
    """
    use_sudo = os.getenv("H2KVM_VMCRAFT_USE_SUDO", "").strip().lower() in {
        "1",
        "true",
        "yes",
        "on",
