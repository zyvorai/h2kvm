...
from h2kvm.vmcraft.services import execute_chroot_command, execute_chroot_command_with_mounts
from h2kvm.vmcraft.storage import LVMActivator, LVMCreator
...
class StorageOps:
    ...
    def cryptsetup_open(self, device: str, name: str, key: bytes) -> None:
        ...
        if os.path.exists(mapper):
            ...
            # h2kvm/fixers/offline_fixer.py (lvs LVM scan) --
