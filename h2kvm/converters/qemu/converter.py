...
# h2kvm/converters/qemu/converter.py
...
# h2kvm/converters/flatten.py's progress parser, but the two differ in real
                ...
                if atomic:
                    if not tmp_dst.exists():
                        raise FileNotFoundError(
                            ...
                            "Free space under /var/lib/h2kvm or disable auto-cleanup, then retry."
                        )
