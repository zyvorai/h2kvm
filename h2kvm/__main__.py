...
"""Main entry point for h2kvm CLI application."""
...
from .core.exceptions import Fatal, H2KvmError, format_exception_for_cli
...
def main() -> None:  # pylint: disable=too-many-branches,too-many-statements
    ...
    # traditional workflows, each with its own Fatal/H2KvmError/generic
    # exception handling; splitting it would hurt readability more than help.
    """
    Main entry point for h2kvm CLI.
