...
```python
from h2kvm.pipeline import DiskConverter
...
```python
from h2kvm.pipeline import NBDAttach
...
```python
from h2kvm.pipeline import RootDetector
...
```python
from h2kvm.pipeline import LUKSEncryptor
...
```python
from h2kvm.pipeline import FilesystemMigrator
...
```python
from h2kvm.pipeline import CrypttabUpdater
...
```python
from h2kvm.pipeline import TPMEnroll
...
```python
from h2kvm.pipeline import InitramfsBuilder
...
```python
from h2kvm.pipeline import GrubUpdater
...
```python
from h2kvm.pipeline import H2KVMVMwareToLUKSPipeline
...
df -h /mnt/h2kvm_source /mnt/h2kvm_target
```
...
| Feature | H2KVM Pipeline | Manual Process |
|---------|-------------------|----------------|
...
help(H2KVMVMwareToLUKSPipeline)
```
