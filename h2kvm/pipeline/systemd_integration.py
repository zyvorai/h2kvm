...
This module integrates systemd tools into the h2kvm migration pipeline
...
class SystemdPipelineIntegration:
    ...
    def encrypt_credential(self, name: str, value: str) -> Path:
        ...
        output_path = Path(f"/var/lib/h2kvm/credentials/{name}.cred")
    ...
    def run_conversion_with_limits(
        ...
        *,
        ...
        result = self.run.run(
            ...
            cpu_quota=cpu_quota,
            unit_name=f"h2kvm-convert-{input_path.stem}",
        )
