...
# h2kvm/core/metrics.py
"""
Prometheus metrics for h2kvm.
...
migrations_active = Gauge(
    "h2kvm_migrations_active", "Number of currently active migrations", registry=registry
)
...
disk_conversion_bytes_total = Counter(
    "h2kvm_disk_conversion_bytes_total",
...
disk_conversion_duration_seconds = Histogram(
    "h2kvm_disk_conversion_duration_seconds",
...
disk_conversion_throughput_mbps = Histogram(
    "h2kvm_disk_conversion_throughput_mbps",
...
vmware_api_duration_seconds = Histogram(
    "h2kvm_vmware_api_duration_seconds",
...
vmware_downloads_bytes_total = Counter(
    "h2kvm_vmware_downloads_bytes_total", "Total bytes downloaded from VMware", registry=registry
)
...
process_start_time_seconds = Gauge(
    "h2kvm_process_start_time_seconds", "Unix timestamp when process started", registry=registry
)
...
build_info = Info("h2kvm_build", "Build information", registry=registry)
...
manifests_processed_total = Counter(
    "h2kvm_manifests_processed_total",
...
vmcraft_nbd_connect_seconds = Histogram(
    "h2kvm_vmcraft_nbd_connect_seconds",
...
vmcraft_lvm_activation_seconds = Histogram(
    "h2kvm_vmcraft_lvm_activation_seconds",
...
vmcraft_vm_activation_total = Counter(
    "h2kvm_vmcraft_vm_activation_total",
...
vmcraft_storage_failures_total = Counter(
    "h2kvm_vmcraft_storage_failures_total",
...
vmcraft_isolation_violations_total = Counter(
    "h2kvm_vmcraft_isolation_violations_total",
