...
"""OpenAPI specification for h2kvm Worker API."""
...
OPENAPI_SPEC = {
    "openapi": "3.0.3",
    "info": {
        "title": "h2kvm Worker API",
        "version": "0.3.0",
        "description": "REST API for h2kvm migration workers. Manages jobs, health checks, and capabilities.",
    ...
    "components": {
        ...
        "securitySchemes": {
            "bearerAuth": {
                "type": "http",
                "scheme": "bearer",
                "description": "Token from H2KVM_API_TOKEN env var",
            }
        },
    },
}
