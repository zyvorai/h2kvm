...
class AnalyticsReportGenerator:
    ...
    def generate_markdown_report(self) -> str:
        ...
        report = f"""# h2kvm Analytics Report
...
*Report generated by h2kvm analytics engine*
"""
...
<head>
    <meta charset="UTF-8">
    <title>h2kvm Analytics Report</title>
    <style>
        body {{
...
def main():
    ...
    print("=" * 80)
    print(" h2kvm Analytics Report Generator")
    print("=" * 80)
    print()
